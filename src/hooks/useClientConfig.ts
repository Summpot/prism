...
export function useClientConfig() {
	...
	return {
		...
		setAutostart: (val: boolean) => patchActiveConfig({ autostart: val }),
		silentAutostart: cfg.silent_autostart ?? true,
		setSilentAutostart: (val: boolean) => patchActiveConfig({ silent_autostart: val }),
		autoCheckUpdate: cfg.auto_check_update ?? true,
