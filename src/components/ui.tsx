	...
	return (
		<Empty className="border border-dashed border-border bg-muted/20">
			<EmptyHeader>
				...
				{label || description ? <EmptyDescription>{label ?? description}</EmptyDescription> : null}
				{label && description ? (
...
export function NestedPanel({ children, className }: { children: ReactNode; className?: string }) {
	return (
